...
modelConf = "yolov3-tiny-280120.cfg"
#modelWeights = "yolov3-tiny.weights"
#modelWeights = "yolov3_last.weights"
modelWeights = "yolov3-tiny-280120_2000.weights"
    ...
    for out in outs:
        for detection in out:
            ...
            if confidence > confThreshold:
                #center (centerX, centerY) for the object is calculated
...
while cv.waitKey(1) < 0:
    ...
    cnt_num_frames=cnt_num_frames-1
    if (cnt_num_frames==0):
        end=time.time()
        seconds = end - start
        fps  = 120 / seconds;
